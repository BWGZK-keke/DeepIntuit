...
model_name_or_path="/mnt/bn/themis/kezhang/opensource-code/stage1_model_opensource"
output_dir="/mnt/bn/themis/kezhang/opensource-code/stage2_model_opensource"
max_frames=32
...
applied_gpu_num=${ARNOLD_APPLIED_GPU_NUM:-1}
if ! [[ "$applied_gpu_num" =~ ^[0-9]+$ ]] || [ "$applied_gpu_num" -le 0 ]; then
    applied_gpu_num=1
fi
gradient_accumulation_steps=$((256 / applied_gpu_num))
